...
NOTION_DEFAULT_RATES_DATABASE_ID = os.environ.get("NOTION_DEFAULT_RATES_DATABASE_ID", "")
NOTION_CURRENCY_RATES_DATABASE_ID = os.environ.get("NOTION_CURRENCY_RATES_DATABASE_ID", "")
NOTION_EXCEPTIONS_RATES_DATABASE_ID = os.environ.get("NOTION_EXCEPTIONS_RATES_DATABASE_ID", "")
NOTION_INTERNAL_RATES_DATABASE_ID = os.environ.get("NOTION_INTERNAL_RATES_DATABASE_ID", "")
