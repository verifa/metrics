...
from metrics.tempo_figures import (figureEarningsVersusWorkload, figureFinancialTotal, figureNormalisedIndividual, figureNormalisedTeam,
                                   figureRollingIncomeIndividual, figureRollingIncomeTeam, figureRollingTotal, figureSpentTimePercentage)
